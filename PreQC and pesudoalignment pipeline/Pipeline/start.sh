...
input="/hpcfs/users/a1763076/pig_oocyte/fastq_files/"
output="/hpcfs/users/a1763076/pig_oocyte/json_output"
template="/hpcfs/users/a1763076/pig_oocyte/json_input/template.json"
